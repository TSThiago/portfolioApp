    ...
    return (
        <BioContainer>
            <BioHeader backgroundColor={gray}>
                ...
                <Grayscale>
                    <Image style={{width: 280, height: 310, zIndex: 1, }} source={require('../../../assets/images/Zizau.png')} />
                </Grayscale>
            </BioHeader>
            <BioInfos>
            ...
            <Image style={{ position: 'absolute', left: -342, top: 124, zIndex: 0.2 }} source={require('../../../assets/images/Rings.png')} />
            <Image style={{ position: 'absolute', left: 342, top: 254 }} source={require('../../../assets/images/Oval.png')} />
        </BioContainer>
    );
};
